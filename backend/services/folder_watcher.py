...
class VideoHandler(FileSystemEventHandler):
    ...
    def process_file(self, filepath):
        ...
        if filepath.stem.endswith("_ig"):
            # Instagram companion file for a standard clip -- picked up as a
            # sibling when the standard clip is uploaded (background_worker.py),
            # not treated as its own video.
            return
