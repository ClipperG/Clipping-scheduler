...
def schedule_single_video(video_id):
    ...
    try:
        ...
        # Instagram channels get the logo'd variant; everyone else
        # (YouTube, TikTok) gets the plain one. Falls back to the standard
        # file if no Instagram variant was uploaded for this clip.
